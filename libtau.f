...
c   the crustal branch and core phase branch identifiers.
 ...
 5    if(l.ge.8) go to 3
     ...
     1 phtmp(l:l+1).ne.'df') go to 3
      ...
      go to 4
 3    continue
c-4    print *,'j phcd phtmp =',j,' ',phcd(j),' ',phtmp
c
...
c                 quatratic.  However, try solving both with and without the
...
205      format(/(1x,i5,2x,a,2f8.2,i5))
         write(10,206)(i,(tp(i,j),j=1,2),i=1,jbrnu)
